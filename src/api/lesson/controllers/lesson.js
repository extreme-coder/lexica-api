  ...
  async create(ctx) {
    ...
    const systemPrompt = includePractice 
      ? `You are a helpful assistant that divides lesson content into logical 
         ...
         Each section should be 2-3 sentences, the lesson should have 3-4 sections. 
         Use simple language, analogies, make the content easy to understand, because these lessons are for teens.
